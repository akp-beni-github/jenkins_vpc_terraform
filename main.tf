...
module "jenkins" {
  ...
  sg_for_jenkins            = [module.security_group.sg_ec2_sg_ssh_http_id, module.security_group.sg_ec2_jenkins_port_8080] #using both sg for public access and jenkin automation
